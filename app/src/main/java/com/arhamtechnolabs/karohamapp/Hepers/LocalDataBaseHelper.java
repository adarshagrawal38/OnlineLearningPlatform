...
public class LocalDataBaseHelper {
    ...
    public LocalDataBaseHelper(Context c) {
        ...
        //database.execSQL("Create table if NOT EXISTS "+wishListTable+" (courseId varchar, courseTitle varchar, coursePrice varchar , discountFlag varchar, discountedPrice varchar, userId varchar, isFreeCourse varchar, thumbnail varchar, ratings varchar)");
    ...
    public void insertData(CartModel data) {
        try{
            String insertQuery = "Insert into " + tableName + " Values ('" + data.getCourseId() + "', '"+data.getCourseTitle()+"', '"+data.getCoursePrice() +"', '"+data.getCourseDiscountFlag()+"', '"+
                    ...
                    data.getUserId() +"', '"+ data.getIsFreeCourse()+"', '"+data.getThumbnail() + "')";
            String description = "";
    ...
    public boolean isCourseAddedToCart(CartModel data) {
        try{
    ...
    public List<CartModel> fetchCartData() {
    ...
    public int getTotalItemsInCart() {
        List<CartModel> result = fetchCartData();
        return result.size();
    }
